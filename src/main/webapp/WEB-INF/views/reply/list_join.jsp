...
<jsp:include page="../menu/top.jsp" flush='false' />
  ...
  <ASIDE class='aside_right'>
    <A href='../restcategrp/list.do'>카테고리 그룹</A>
    ...
    <table class="table table-striped" style='width: 100%;'>
      ...
      <tbody>
        <c:forEach var="replyMemberVO" items="${list }">
          ...
          <c:set var="restcontentsno" value="${replyMemberVO.restcontentsno }" />
          ...
          <tr style='height: 50px;'> 
            ...
            <td style='text-align: center; vertical-align: middle;'>
              <A href='../restcontents/read.do?restcontentsno=${restcontentsno }'>${restcontentsno}</A>
            </td>
            <td style='text-align: center; vertical-align: middle;'>
