...
<DIV class='content_body'>
  <!-- <FORM name='frm' method='POST' action='http://localhost:9091/restcate/create.do'> -->
  <!-- <FORM name='frm' method='POST' action='/restcate/create.do'> -->
  <FORM name='frm' method='POST' action='./create.do'> <!-- /restcate 폴더 자동 인식, 권장 -->
    <div>
       <label>카테고리 이름</label>
