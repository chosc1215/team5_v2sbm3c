    ...
    <tbody>
      <c:forEach var="restcontentsVO" items="${list}">
        ...
        <c:set var="rdate" value="${restcontentsVO.rdate.substring(0, 16) }" />
         ...
         <tr style="height: 112px;" onclick="location.href='./read.do?restcontentsno=${restcontentsno }&word=${param.word }&now_page=${param.now_page == null ? 1 : param.now_page }'" class='hover'>
