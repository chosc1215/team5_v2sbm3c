...
<c:set var="thumb1" value="${restcontentsVO.thumb1.toLowerCase() }" />
...
<DIV class='title_line'><A href="./list_by_restcateno_search_paging.do?restcateno=${restcateno }" class='title_link'>${restcateVO.name }</A> > 파일 수정</DIV>
      ...
      <li class="li_none">
        <DIV style='text-align: center; width: 50%; float: left;'>
          <c:choose>
            ...
            <c:otherwise> <!-- 이미지가 없음 -->
               <IMG src="/restcontents/images/none1.png" style="width: 90%;"> 
            </c:otherwise>
          </c:choose>
