...
<c:set var="restcateno" value="${param.restcateno }" /> <%-- mav.addObject("restcateno", contentsVO.getCateno()); // redirect parameter 적용 --%>
  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='./create.do?restcateno=${restcateno}'" class="btn btn-info btn-sm">새로운 컨텐츠 등록</button>
        <button type='button' onclick="location.href='./list_by_restcateno.do?restcateno=${restcateno}'" class="btn btn-info btn-sm">목록</button>
        <button type='button' onclick="location.href='./list_by_restcateno_grid.do?restcateno=${restcateno}'" class="btn btn-info btn-sm">갤러리 목록</button>
      </LI>
    </UL>
  </fieldset>
