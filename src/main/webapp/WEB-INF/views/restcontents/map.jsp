...
<DIV class='title_line'><A href="/restcontents/list_by_restcateno.do?restcateno=${restcateVO.restcateno }" class="title_link">${restcateVO.name }</A> > ${restcontentsVO.title } > 지도 등록/수정/삭제</DIV>
...
<DIV class='content_body'>
  ...
  <FORM name='frm_map' method='POST' action='./map.do'>
    ...
    <div>
       <label>지도 스크립트</label>
       <textarea name='map' class="form-control" rows="12" style='width: 100%;'>${restcontentsVO.map }</textarea>
    </div>
  ...
  <DIV style="text-align: center;">
      ...
      <IMG src='/restcontents/images/map01.jpg' style='width: 60%;'><br><br>
      <IMG src='/restcontents/images/map02.jpg' style='width: 60%;'><br><br>
      <IMG src='/restcontents/images/map03.jpg' style='width: 60%;'><br><br>
      <IMG src='/restcontents/images/map04.jpg' style='width: 60%;'><br><br>
      <IMG src='/restcontents/images/map05.jpg' style='width: 60%;'><br>
  </DIV>
